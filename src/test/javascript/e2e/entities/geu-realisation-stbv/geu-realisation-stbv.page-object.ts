...
export class GeuRealisationSTBVComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-geu-realisation-stbv div table .btn-danger'));
  title = element.all(by.css('jhi-geu-realisation-stbv div h2#page-heading span')).first();
...
export class GeuRealisationSTBVUpdatePage {
  pageTitle = element(by.id('jhi-geu-realisation-stbv-heading'));
...
export class GeuRealisationSTBVDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-geuRealisationSTBV-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-geuRealisationSTBV'));
