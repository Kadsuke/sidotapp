...
import { TypeAnalyseComponent } from 'app/entities/type-analyse/type-analyse.component';
...
describe('Component Tests', () => {
  describe('TypeAnalyse Management Component', () => {
    let comp: TypeAnalyseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeAnalyseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeAnalyses && comp.typeAnalyses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
