...
import { PrestataireComponent } from 'app/entities/prestataire/prestataire.component';
...
describe('Component Tests', () => {
  describe('Prestataire Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.prestataires && comp.prestataires[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
