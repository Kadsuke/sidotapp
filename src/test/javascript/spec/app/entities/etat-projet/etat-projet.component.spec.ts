...
import { EtatProjetComponent } from 'app/entities/etat-projet/etat-projet.component';
...
describe('Component Tests', () => {
  describe('EtatProjet Management Component', () => {
    let comp: EtatProjetComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EtatProjetComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.etatProjets && comp.etatProjets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
