...
import { TypeEquipementComponent } from 'app/entities/type-equipement/type-equipement.component';
...
describe('Component Tests', () => {
  describe('TypeEquipement Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeEquipements && comp.typeEquipements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
