...
import { DirectionRegionaleComponent } from 'app/entities/direction-regionale/direction-regionale.component';
  ...
  describe('DirectionRegionale Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new DirectionRegionale(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.directionRegionales && comp.directionRegionales[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
