...
import { TacheronsComponent } from 'app/entities/tacherons/tacherons.component';
...
describe('Component Tests', () => {
  describe('Tacherons Management Component', () => {
    let comp: TacheronsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TacheronsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tacherons && comp.tacherons[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
