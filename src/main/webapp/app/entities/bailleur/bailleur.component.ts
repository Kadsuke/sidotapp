...
export class BailleurComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.bailleurService
      ...
      .subscribe(
        (res: HttpResponse<IBailleur[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInBailleurs(): void {
    this.eventSubscriber = this.eventManager.subscribe('bailleurListModification', () => this.loadPage());
  }
