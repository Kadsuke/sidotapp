...
export class LaboratoireComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.laboratoireService
      ...
      .subscribe(
        (res: HttpResponse<ILaboratoire[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLaboratoires(): void {
    this.eventSubscriber = this.eventManager.subscribe('laboratoireListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ILaboratoire[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
