...
export class CentreComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.centreService
      ...
      .subscribe(
        (res: HttpResponse<ICentre[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCentres(): void {
    this.eventSubscriber = this.eventManager.subscribe('centreListModification', () => this.loadPage());
  }
