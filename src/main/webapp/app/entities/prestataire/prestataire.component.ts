...
export class PrestataireComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.prestataireService
      ...
      .subscribe(
        (res: HttpResponse<IPrestataire[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPrestataires(): void {
    this.eventSubscriber = this.eventManager.subscribe('prestataireListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPrestataire[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
