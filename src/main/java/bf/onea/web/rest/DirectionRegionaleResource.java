...
public class DirectionRegionaleResource {
    ...
    public ResponseEntity<DirectionRegionaleDTO> createDirectionRegionale(@Valid @RequestBody DirectionRegionaleDTO directionRegionaleDTO) throws URISyntaxException {
    ...
    public ResponseEntity<DirectionRegionaleDTO> updateDirectionRegionale(@Valid @RequestBody DirectionRegionaleDTO directionRegionaleDTO) throws URISyntaxException {
