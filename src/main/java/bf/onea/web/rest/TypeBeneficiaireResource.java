...
public class TypeBeneficiaireResource {
    ...
    public ResponseEntity<TypeBeneficiaireDTO> createTypeBeneficiaire(@Valid @RequestBody TypeBeneficiaireDTO typeBeneficiaireDTO) throws URISyntaxException {
    ...
    public ResponseEntity<TypeBeneficiaireDTO> updateTypeBeneficiaire(@Valid @RequestBody TypeBeneficiaireDTO typeBeneficiaireDTO) throws URISyntaxException {
