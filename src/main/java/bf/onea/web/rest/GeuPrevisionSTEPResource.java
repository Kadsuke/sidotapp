...
public class GeuPrevisionSTEPResource {
    ...
    public ResponseEntity<GeuPrevisionSTEPDTO> createGeuPrevisionSTEP(@Valid @RequestBody GeuPrevisionSTEPDTO geuPrevisionSTEPDTO) throws URISyntaxException {
    ...
    public ResponseEntity<GeuPrevisionSTEPDTO> updateGeuPrevisionSTEP(@Valid @RequestBody GeuPrevisionSTEPDTO geuPrevisionSTEPDTO) throws URISyntaxException {
