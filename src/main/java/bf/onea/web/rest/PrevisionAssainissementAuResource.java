...
public class PrevisionAssainissementAuResource {
    ...
    public ResponseEntity<PrevisionAssainissementAuDTO> createPrevisionAssainissementAu(@RequestBody PrevisionAssainissementAuDTO previsionAssainissementAuDTO) throws URISyntaxException {
    ...
    public ResponseEntity<PrevisionAssainissementAuDTO> updatePrevisionAssainissementAu(@RequestBody PrevisionAssainissementAuDTO previsionAssainissementAuDTO) throws URISyntaxException {
