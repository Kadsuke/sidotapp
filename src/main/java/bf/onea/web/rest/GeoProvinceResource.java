...
public class GeoProvinceResource {
    ...
    public ResponseEntity<GeoProvinceDTO> createGeoProvince(@RequestBody GeoProvinceDTO geoProvinceDTO) throws URISyntaxException {
    ...
    public ResponseEntity<GeoProvinceDTO> updateGeoProvince(@RequestBody GeoProvinceDTO geoProvinceDTO) throws URISyntaxException {
