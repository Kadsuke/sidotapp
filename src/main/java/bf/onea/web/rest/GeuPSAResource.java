...
public class GeuPSAResource {
    ...
    public ResponseEntity<GeuPSADTO> createGeuPSA(@RequestBody GeuPSADTO geuPSADTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/geu-psas")
    public ResponseEntity<GeuPSADTO> updateGeuPSA(@RequestBody GeuPSADTO geuPSADTO) throws URISyntaxException {
