...
public class GeuRealisationResource {
    ...
    public ResponseEntity<GeuRealisationDTO> createGeuRealisation(@Valid @RequestBody GeuRealisationDTO geuRealisationDTO) throws URISyntaxException {
    ...
    public ResponseEntity<GeuRealisationDTO> updateGeuRealisation(@Valid @RequestBody GeuRealisationDTO geuRealisationDTO) throws URISyntaxException {
