...
import bf.onea.service.LaboratoireService;
...
/**
 * REST controller for managing {@link bf.onea.domain.Laboratoire}.
 */
@RestController
@RequestMapping("/api")
public class LaboratoireResource {
    ...
    public ResponseEntity<LaboratoireDTO> updateLaboratoire(@RequestBody LaboratoireDTO laboratoireDTO) throws URISyntaxException {
    ...
    public ResponseEntity<List<LaboratoireDTO>> getAllLaboratoires(Pageable pageable) {
