...
public class ModeEvacuationEauUseeResource {
    ...
    public ResponseEntity<ModeEvacuationEauUseeDTO> createModeEvacuationEauUsee(@RequestBody ModeEvacuationEauUseeDTO modeEvacuationEauUseeDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ModeEvacuationEauUseeDTO> updateModeEvacuationEauUsee(@RequestBody ModeEvacuationEauUseeDTO modeEvacuationEauUseeDTO) throws URISyntaxException {
